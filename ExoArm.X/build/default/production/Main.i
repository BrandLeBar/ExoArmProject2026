...
Setup:
    ...
    ;----------------------------------------------------------
    MOVLB 0x03 ;Bank 3
    MOVLW 0x01 ;Enable ((PORTA) and 07Fh), 0 as analog input
    ...
    ;----------------------------------------------------------
    MOVLB 0x01 ;Bank 1
    MOVLW 0x0F ;Set ((PORTA) and 07Fh), 0, ((PORTA) and 07Fh), 1, ((PORTA) and 07Fh), 2, and ((PORTA) and 07Fh), 3 as inputs
    ...
    MOVWF ADCON0 ;Configures ADC ((ADCON0) and 07Fh), 1/((ADCON0) and 07Fh), 1, Enable, AN0-13, 10 or 12 Bit
